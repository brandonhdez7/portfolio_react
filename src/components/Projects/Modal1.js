...
import BudgetHobo from '../../Images/thebudgethobo.png'
...
class Modal1 extends Component {
    ...
    render () {
      ...
      return (
        <div>
          <button className='btn' onClick={this.modalToggle}>Financial Budget<br/>(Back-End Project)</button>
